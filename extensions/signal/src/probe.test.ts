...
describe("probeSignal", () => {
  beforeEach(() => {
    vi.restoreAllMocks();
    vi.spyOn(clientAdapterModule, "signalCheck").mockImplementation(signalCheckMock as any);
    vi.spyOn(clientAdapterModule, "signalRpcRequest").mockImplementation(
      signalRpcRequestMock as any,
    );
  });
